/*! For license information please see 61606.TWymNZV3dB8.js.LICENSE.txt */
export const id=61606;export const ids=[61606];export const modules={54854:(e,t,i)=>{i.d(t,{d:()=>l});var s=i(3358),o=i(40924),r=i(75031);const n=Symbol("valueNotInitialized");class a extends r.Kq{constructor(e){if(super(e),e.type!==s.OA.ELEMENT)throw new Error(`\`${this.constructor.name}\` must be bound to an element.`);this.previousValue=n}render(e,t){return o.s6}update(e,[t,i]){if(!this.hasChanged(i))return o.s6;this.host=e.options&&e.options.host,this.element=e.element,this.renderer=t;return this.previousValue===n?this.addRenderer():this.runRenderer(),this.previousValue=Array.isArray(i)?[...i]:i,o.s6}reconnected(){this.addRenderer()}disconnected(){this.removeRenderer()}addRenderer(){throw new Error("The `addRenderer` method must be implemented.")}runRenderer(){throw new Error("The `runRenderer` method must be implemented.")}removeRenderer(){throw new Error("The `removeRenderer` method must be implemented.")}renderRenderer(e,...t){const i=this.renderer.call(this.host,...t);(0,o.XX)(i,e,{host:this.host})}hasChanged(e){return Array.isArray(e)?!Array.isArray(this.previousValue)||(this.previousValue.length!==e.length||e.some(((e,t)=>e!==this.previousValue[t]))):this.previousValue!==e}}const l=(0,s.u$)(class extends a{addRenderer(){this.element.renderer=(e,t,i)=>{this.renderRenderer(e,i.item,i,t)}}runRenderer(){this.element.requestContentUpdate()}removeRenderer(){this.element.renderer=null}})},91453:(e,t,i)=>{function s(e){const t=customElements.get(e.is);if(t){const i=t.version;i&&e.version&&i===e.version?console.warn(`The component ${e.is} has been loaded twice`):console.error(`Tried to define ${e.is} version ${e.version} when version ${t.version} is already in use. Something will probably break.`)}else Object.defineProperty(e,"version",{get:()=>"24.3.11"}),customElements.define(e.is,e)}class o extends HTMLElement{static get is(){return"vaadin-material-styles"}}s(o);var r=i(90392),n=i(45584);const a=(e,...t)=>{(0,n.qV)(`material-${e}`,t)},l=r.AH`
  :host {
    /* Text colors */
...
`;(0,r.SF)("",l,{moduleId:"material-color-light"});const h=r.AH`
  :host {
    /* Text colors */
    --material-body-text-color: var(--dark-theme-text-color, rgba(255, 255, 255, 1));
    --material-secondary-text-color: var(--dark-theme-secondary-color, rgba(255, 255, 255, 0.7));
...
`;(0,r.SF)("",h,{moduleId:"material-color-dark"});a("color-base",r.AH`
  :host {
    /* Text colors */
    --material-body-text-color: var(--light-theme-text-color, rgba(0, 0, 0, 0.87));
    --material-secondary-text-color: var(--light-theme-secondary-color, rgba(0, 0, 0, 0.54));
...
`;(0,r.SF)("vaadin-item",d,{moduleId:"material-item"});const c=r.AH`
  :host {
    cursor: pointer;
...
`;(0,r.SF)("vaadin-combo-box-item",[d,c],{moduleId:"material-combo-box-item"});const u=r.AH`
  [part~='loader'] {
    height: 2px;
...
`;(0,r.SF)("",_,{moduleId:"material-overlay"});const p=_;(0,r.SF)("",p,{moduleId:"material-menu-overlay"});const m=r.AH`
  [part='overlay'] {
    position: relative;
    overflow: visible;
